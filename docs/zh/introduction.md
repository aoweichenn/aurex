...
- 下一步进入 M20b Owned Dyn IR Shape Prototype Gate；M20a 已把 dyn ownership runtime boundary
  固定为 admission facts 和准入顺序。owning dyn 用户值、`Box<dyn Trait>`、dynamic Drop dispatch、标准库
