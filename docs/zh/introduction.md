...
- 通过常规仓库测试、90% coverage gate、query/cache/profile gates、stress gates 和文档检查保持 M10b supertrait
  frontend/query/sema baseline 稳定。
...
- owning dyn、`Box<dyn Trait>`、dynamic Drop dispatch、supertrait upcasting runtime lowering、多 trait object composition、
