...
- 通过常规仓库测试、90% coverage gate、query/cache/profile gates、stress gates 和文档检查保持 M10d supertrait
  release baseline、M11a/M11b composition facts 和 M11c check-only borrowed composition 稳定。
...
- M11d 继续推进 principal-set composition IR/backend runtime；owning dyn、`Box<dyn Trait>`、dynamic Drop
