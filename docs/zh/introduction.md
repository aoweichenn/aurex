...
- 通过常规仓库测试、90% coverage gate、query/cache/profile gates、stress gates 和文档检查保持 M10d supertrait
  release baseline、M11a/M11b composition facts、M11c borrowed composition frontend/sema 和 M11d runtime projection 稳定。
...
- M11e 继续推进 principal-set composition hardening/release closure；owning dyn、`Box<dyn Trait>`、dynamic Drop
