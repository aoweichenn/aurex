...
状态：当前实现清单、M10d 完成面、M11 principal-set composition release、M12 direct composition dispatch release closure 与后续非目标

本文记录当前仓库真实支持的 Aurex 语言表面、已具备的高级能力、未完成能力、M10d hardening/release closure 的完成范围、M11 principal-set composition release closure 和 M12 direct composition dispatch release closure。本文以 `include/aurex/frontend/syntax/core/token.hpp`、`include/aurex/frontend/syntax/ast/*`、`src/frontend/parse/*`、`src/frontend/sema/*`、`src/midend/ir/*`、`src/backend/llvm/*`、`tests/samples/**` 为准；M11a gate 另以 `include/aurex/infrastructure/query/dyn_advanced_design_gate.hpp` 和 `src/infrastructure/query/dyn_advanced_design_gate.cpp` 为准；M11/M12 principal-set facts 另以 `include/aurex/infrastructure/query/principal_set_composition_facts.hpp`、`include/aurex/infrastructure/query/dyn_abi_facts.hpp`、`src/infrastructure/query/dyn_abi_facts.cpp`、`src/infrastructure/query/lower_function_ir_query.cpp`、`src/application/tooling/ide/ide.cpp`、`src/midend/ir/core/ir_dyn_abi_facts.cpp`、`src/frontend/sema/facade/sema_call.cpp`、`tests/gtest/frontend/sema/dyn_trait_composition_tests.cpp`、`tests/gtest/midend/ir/lower_ast_dyn_trait_tests.cpp`、`tests/gtest/infrastructure/query/trait_object_upcast_key_tests.cpp` 和 `tests/gtest/integration/native_execution_tests.cpp` 为准。
