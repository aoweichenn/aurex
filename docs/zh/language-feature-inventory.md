...
`compiler_owned_attached_item_token_materialization_admission_v1` 和 `compiler_owned_empty_token_stream`。真实宏展开、
generated module part real token materialization、generated source text、parser-consumable generated token buffer、
