...
- owning dyn / trait-object Drop dispatch / composition-to-supertrait 隐式多步 direct dispatch；M11a 完成
  ...
  composition runtime facts/query/tooling/verifier hardening，M12a 完成唯一 principal method direct dispatch。
