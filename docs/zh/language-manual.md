...
- closure/lambda capture、async/generator borrow、HRTB/full variance、dyn object lifetime bounds、owning dyn、
  dynamic Drop dispatch、marker-only cleanup 的 runtime ABI call 和 unsafe/raw pointer
  alias proof 仍是后续阶段，不属于当前 M8。
