...
12. Compact AST 和 bump allocator 作为 M2.1 后半段优化。
   ...
   - 后续目标：payload 内部小 vector、generic side table 生命周期、跨模块 stable hash / parallel global ID、2M AST 节点跨机器 RSS/耗时阈值。
