...
当前实现基线是 M6 Resource And Access Semantics。M6-WP2/WP3/WP4 已落地资源分类、whole-local move
analysis 和 cleanup obligation lowering；较早的 M2 `language-core-no-std` 阶段用于隔离语言核心验证：
