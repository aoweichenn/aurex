...
M11 已结束。M12a 已在此基础上打开 unambiguous direct principal composition dispatch，但仍继续不实现标准库、
owning dyn、`Box<dyn Trait>`、allocator 和 dynamic Drop dispatch；这些能力仍进入独立后续阶段。
