...
inline constexpr std::string_view BACKEND_LLVM_NULL_MODULE = "LLVM backend received a null IR module";

[[nodiscard]] inline std::string backend_llvm_target_lookup_failed_message(
    const std::string_view triple, const std::string_view error)
{
