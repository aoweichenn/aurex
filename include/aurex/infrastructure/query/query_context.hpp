...
#include <aurex/infrastructure/query/query_graph.hpp>
#include <aurex/infrastructure/query/query_interner.hpp>
#include <aurex/infrastructure/query/query_provider_set.hpp>
...
public:
    ...
    [[nodiscard]] QueryEvaluationResult evaluate_module_package_exports(const ModulePackageExportsProviderInput& input);
