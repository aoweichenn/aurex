...
inline constexpr std::string_view IR_VERIFY_FAILED_HEADER =
    "IR verification failed:";

inline constexpr std::string_view IR_VERIFY_CONSTANT_ID_INVALID =
    "constant id is invalid";

inline constexpr std::string_view IR_VERIFY_CYCLIC_CONSTANT_DEFINITION =
...
inline constexpr std::string_view IR_VERIFY_CONSTANT_INITIALIZER_TYPE_MISMATCH =
    "constant initializer type mismatch";

inline constexpr std::string_view IR_VERIFY_CYCLIC_CONSTANT_REFERENCE =
...
inline constexpr std::string_view IR_VERIFY_AGGREGATE_RESULT_RECORD =
...
inline constexpr std::string_view IR_VERIFY_FUNCTION_EMPTY_ABI_SYMBOL =
    "function has an empty ABI symbol";

inline constexpr std::string_view IR_VERIFY_INVALID_VALUE_IN_BLOCK =
    "invalid value in block";

inline constexpr std::string_view IR_VERIFY_STORE_RESULT_VOID =
    "store result must be void";

inline constexpr std::string_view IR_VERIFY_STORE_TARGET_MUTABLE =
    "store target must be mutable";

inline constexpr std::string_view IR_VERIFY_CAST_RESULT_TARGET =
    "cast result type must match cast target type";

inline constexpr std::string_view IR_VERIFY_UNARY_OPERAND_INVALID =
...
inline constexpr std::string_view IR_VERIFY_BINARY_OPERAND_TYPE_MISMATCH =
    "binary operand type mismatch";

inline constexpr std::string_view IR_VERIFY_BINARY_OPERAND_TYPE_INVALID =
    "binary operand type is invalid";

inline constexpr std::string_view IR_VERIFY_COMPARISON_RESULT_BOOL =
    "comparison binary result must be bool";

inline constexpr std::string_view IR_VERIFY_COMPARISON_OPERANDS_NUMERIC =
    "comparison binary operands must be numeric";

inline constexpr std::string_view IR_VERIFY_EQUALITY_RESULT_BOOL =
    "equality binary result must be bool";

inline constexpr std::string_view IR_VERIFY_EQUALITY_OPERANDS_SCALAR =
...
inline constexpr std::string_view IR_VERIFY_INTEGER_BINARY_RESULT =
...
inline constexpr std::string_view IR_VERIFY_NUMERIC_BINARY_RESULT =
...
inline constexpr std::string_view IR_VERIFY_PHI_INCOMING_REQUIRED =
    "phi has no incoming values";

inline constexpr std::string_view IR_VERIFY_PHI_DUPLICATE_PREDECESSOR =
    "phi has duplicate incoming predecessor";

inline constexpr std::string_view IR_VERIFY_PHI_PREDECESSOR_EDGE =
    "phi predecessor has no edge to block";

inline constexpr std::string_view IR_VERIFY_PHI_MISSING_PREDECESSOR =
    "phi is missing incoming predecessor";

inline constexpr std::string_view IR_VERIFY_CALL_NO_TARGET =
    "call has no target symbol";

inline constexpr std::string_view IR_VERIFY_CALL_TARGET_OUT_OF_RANGE =
    "call target out of range";

inline constexpr std::string_view IR_VERIFY_CALL_ARGUMENT_OUT_OF_RANGE =
...
inline constexpr std::string_view IR_VERIFY_STRING_LITERAL_TYPE =
    "string literal type must be str";

inline constexpr std::string_view IR_VERIFY_C_STRING_LITERAL_TYPE =
    "c string literal type must be *const u8";

inline constexpr std::string_view IR_VERIFY_BYTE_LITERAL_TYPE =
    "byte literal type must be u8";

inline constexpr std::string_view IR_VERIFY_UNDEF_VOID =
    "undef value cannot have void type";

inline constexpr std::string_view IR_VERIFY_ALLOCA_POINTER =
    "alloca result must be a pointer";

inline constexpr std::string_view IR_VERIFY_ALLOCA_MUT_POINTER =
    "alloca result must be a mutable pointer";

inline constexpr std::string_view IR_VERIFY_LOAD_RESULT_NONVOID =
    "load result must not be void";

inline constexpr std::string_view IR_VERIFY_LOAD_RESULT_TYPE =
    "load result type mismatch";

inline constexpr std::string_view IR_VERIFY_STRPTR_RESULT =
...
inline constexpr std::string_view IR_VERIFY_STRRAW_ARITY =
...
inline constexpr std::string_view IR_VERIFY_FIELD_ADDRESS_TYPE =
...
inline constexpr std::string_view IR_VERIFY_INDEX_ADDRESS_POINTER =
    "index address result is not a pointer";

inline constexpr std::string_view IR_VERIFY_INDEX_INTEGER =
    "index must be an integer";

inline constexpr std::string_view IR_VERIFY_INDEX_ADDRESS_TYPE =
...
inline constexpr std::string_view IR_VERIFY_AGGREGATE_MISSING_FIELD =
...
inline constexpr std::string_view IR_VERIFY_ARRAY_AGGREGATE_ELEMENT_COUNT =
