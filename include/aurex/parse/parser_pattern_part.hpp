...
private:
    ...
    [[nodiscard]] bool recover_tuple_pattern_separator() const;
    [[nodiscard]] bool recover_slice_pattern_separator() const;
    [[nodiscard]] bool recover_struct_pattern_separator() const;
