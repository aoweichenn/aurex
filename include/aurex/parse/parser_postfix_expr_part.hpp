...
private:
    ...
    [[nodiscard]] syntax::PostfixOp parse_rejected_legacy_scope_suffix(base::SourceRange fallback_range);
    ...
    [[nodiscard]] syntax::PostfixOp parse_rejected_numeric_tuple_field_suffix(base::SourceRange fallback_range);
    ...
    [[nodiscard]] syntax::PostfixOp parse_try_suffix();
    [[nodiscard]] syntax::PostfixOp parse_rejected_update_suffix(
        base::SourceRange fallback_range,
