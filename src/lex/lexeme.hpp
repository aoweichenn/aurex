...
inline constexpr std::string_view LEXEME_BYTE_STRING_PREFIX = "b\"";
inline constexpr std::string_view LEXEME_RAW_STRING_PREFIX = "r\"";
...
inline constexpr std::string_view LEXEME_UNTERMINATED_RAW_STRING_MESSAGE = "unterminated raw string literal";
inline constexpr std::string_view LEXEME_UNTERMINATED_BYTE_STRING_MESSAGE = "unterminated byte string literal";
inline constexpr std::string_view LEXEME_UNTERMINATED_BYTE_MESSAGE = "unterminated byte literal";
inline constexpr std::string_view LEXEME_UNTERMINATED_CHAR_MESSAGE = "unterminated char literal";
...
inline constexpr std::string_view LEXEME_INVALID_INTEGER_SUFFIX_PREFIX = "invalid integer literal suffix `";
inline constexpr std::string_view LEXEME_INVALID_FLOAT_SUFFIX_PREFIX = "invalid float literal suffix `";
inline constexpr std::string_view LEXEME_INVALID_SUFFIX_SUFFIX = "`";
