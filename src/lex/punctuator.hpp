...
[[nodiscard]] inline PunctuatorMatch match_two_or_one(const char actual_second, const char second,
    const syntax::TokenKind double_kind, const syntax::TokenKind single_kind) noexcept
{
...
[[nodiscard]] inline PunctuatorMatch match_punctuator(const char first, const char second, const char third) noexcept
{
    switch (first) {
        case LEXEME_DOT:
        ...
        case LEXEME_COLON:
            return detail::match_two_or_one(
                second, LEXEME_COLON, syntax::TokenKind::colon_colon, syntax::TokenKind::colon);
        case LEXEME_MINUS:
        ...
        case LEXEME_BANG:
            return detail::match_two_or_one(
                second, LEXEME_EQUAL, syntax::TokenKind::bang_equal, syntax::TokenKind::bang);
        case LEXEME_LESS:
            if (second == LEXEME_EQUAL) {
        ...
        case LEXEME_AMP:
            ...
            return detail::match_two_or_one(second, LEXEME_AMP, syntax::TokenKind::amp_amp, syntax::TokenKind::amp);
        case LEXEME_PIPE:
            if (second == LEXEME_EQUAL) {
                return detail::double_char_match(syntax::TokenKind::pipe_equal);
            }
            return detail::match_two_or_one(second, LEXEME_PIPE, syntax::TokenKind::pipe_pipe, syntax::TokenKind::pipe);
        case LEXEME_L_PAREN:
