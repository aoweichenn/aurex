...
[[nodiscard]] base::u64 nonzero_stable_id(
    const base::u64 marker,
    const base::u64 value) noexcept {
    return value == 0 ? marker : value;
}

[[nodiscard]] base::u64 mix_identity_fingerprint(
    base::u64 seed,
...
IncrementalKey stable_incremental_key(
    ...
    const std::string_view semantic_fingerprint) noexcept {
