...
std::string_view token_kind_name(const TokenKind kind) noexcept {
    ...
    case TokenKind::kw_bitcast: return "kw_bitcast";
    ...
    case TokenKind::kw_strlen: return "kw_strlen";
...
std::string_view expr_kind_name(const ExprKind kind) {
    ...
    case ExprKind::bcast: return "bitcast";
    case ExprKind::size_of: return "sizeof";
    ...
    case ExprKind::str_byte_len: return "strlen";
