...
TEST_F(AurexIntegrationTest, IncrementalCacheWritesGenericInstanceQueryRowsWhenAvailable)
{
    ...
    const query::GenericInstanceSignatureAuthority expected_generic_authority{
        ...
        static_cast<base::u64>(generic_instance_key.type_args.size()),
        static_cast<base::u64>(generic_instance_key.const_args.size()),
        static_cast<base::u64>(generic_instance_key.param_env.predicate_count),
        0,
        0,
        false,
        false,
