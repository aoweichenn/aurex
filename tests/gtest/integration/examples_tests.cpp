...
TEST_F(AurexIntegrationTest, ExamplesDocumentationAndLibrariesArePresent)
{
    ...
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "bytes.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "database.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "database" / "entry.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "database" / "layout.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "database" / "read.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "database" / "shape.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "database" / "storage.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "database" / "validate.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "database" / "write.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "parser.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "parser" / "classes.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "parser" / "cursor.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "parser" / "entry.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "parser" / "escapes.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "parser" / "flags.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "parser" / "grammar.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "parser" / "groups.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "parser" / "literals.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "parser" / "repeats.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "parser" / "state.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "parser" / "unicode_sets.ax"));
    ...
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "set" / "literal_trie.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "compile" / "set" / "storage.ax"));
    ...
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "ops" / "replace" / "engine.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "ops" / "replace" / "output.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "ops" / "replace" / "template.ax"));
    ...
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "vm" / "engine" / "input.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "vm" / "engine" / "literal_set.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "vm" / "engine" / "program.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "vm" / "engine" / "start_filter.ax"));
    EXPECT_TRUE(fs::exists(examples_root() / "libs" / "regex" / "vm" / "engine" / "workspace.ax"));
    ...
    EXPECT_TRUE(fs::exists(examples_root() / "regex_advanced.ax"));
