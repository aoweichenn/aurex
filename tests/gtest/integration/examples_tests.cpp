...
TEST_F(AurexIntegrationTest, M1ExamplesExposeAcceptanceFeatureSet) {
    ...
    expect_contains_all(axbuild_checked, {
        ...
        "fn project_new -> std.core.result.Result<m1.axbuild.main.Project, i32>",
        ...
        "fn target_disown_after_move -> void",
        ...
        "fn cstring_usize_contains -> bool",
        "fn cstring_usize_destroy -> void",
        "fn cstring_usize_get -> std.core.result.Option<usize>",
        "fn cstring_usize_insert_absent -> bool",
        "fn cstring_usize_new -> std.core.map.CStringUsizeMap",
        "fn cstring_usize_remove -> std.core.result.Option<usize>",
        "fn cstring_usize_reserve -> bool",
        "fn directory_entries_from_host -> std.core.result.Result<std.core.vec.Vec<std.fs.dir.DirectoryEntry>, i32>",
        "fn destroy_entries -> void",
        "fn method std.fs.dir.DirectoryEntry.destroy -> void",
        "fn directory_entry_destroy -> void",
        "fn directory_entry_is_directory -> bool",
        "fn directory_entry_is_file -> bool",
        "fn directory_entry_is_symlink -> bool",
        "fn directory_entry_kind -> std.fs.dir.DirectoryEntryKind",
        ...
        "fn read_entries_impl -> std.core.result.Result<std.core.vec.Vec<std.fs.dir.DirectoryEntry>, i32>",
        ...
        "fn method std.core.vec.Vec<std.fs.dir.DirectoryEntry>.destroy_deep -> void",
        "fn std.core.vec.destroy_deep<std.fs.dir.DirectoryEntry> -> void",
        "fn method std.core.vec.Vec<std.fs.path.Path>.destroy_deep -> void",
        "fn std.core.vec.destroy_deep<std.fs.path.Path> -> void",
        "fn method std.core.vec.Vec<m1.axbuild.main.Target>.destroy_deep -> void",
        "fn std.core.vec.destroy_deep<m1.axbuild.main.Target> -> void",
        ...
        "fn method std.fs.dir.DirectoryEntry.is_directory -> bool",
        "fn method std.fs.dir.DirectoryEntry.is_file -> bool",
        "fn method std.fs.dir.DirectoryEntry.is_symlink -> bool",
        "fn method std.fs.dir.DirectoryEntry.kind -> std.fs.dir.DirectoryEntryKind",
        "fn method std.fs.dir.DirectoryEntry.name_c_data -> *const u8",
        ...
        "fn method std.fs.dir.DirectoryEntry.path_c_data -> *const u8",
        ...
        "fn method std.fs.path.Path.as_span -> std.core.text.Span<u8>",
        "fn method std.fs.path.Path.destroy -> void",
        ...
        "fn method std.core.map.CStringUsizeMap.contains -> bool",
        "fn method std.core.map.CStringUsizeMap.destroy -> void",
        ...
        "fn method std.core.map.CStringUsizeMap.len -> usize",
        "fn method std.core.map.CStringUsizeMap.remove -> std.core.result.Option<usize>",
        "fn method std.core.map.CStringUsizeMap.reserve -> bool",
        ...
        "case DirectoryEntryKind_other",
        "case DirectoryEntryKind_symlink",
        "case Option<usize>_some",
        "case Result<m1.axbuild.main.GraphDiagnostic, i32>_ok",
        "case Result<m1.axbuild.main.Project, i32>_err",
        "case Result<m1.axbuild.main.Project, i32>_ok",
        "case Result<std.core.map.CStringUsizeMap, i32>_ok",
        "case Result<std.core.vec.Vec<std.fs.dir.DirectoryEntry>, i32>_ok",
    ...
    expect_contains_all(axbuild_ir, {
        "record CStringUsizeEntry @m0_std_core_map_CStringUsizeEntry",
        "record CStringUsizeMap @m0_std_core_map_CStringUsizeMap",
        ...
        "record std.core.vec.Vec<std.core.map.CStringUsizeEntry> @m0_std_core_vec_Vec__m0_std_core_map_CStringUsizeEntry",
        "record std.core.vec.Vec<std.fs.dir.DirectoryEntry> @m0_std_core_vec_Vec__m0_std_fs_dir_DirectoryEntry",
        "record std.core.vec.Vec<std.fs.path.Path> @m0_std_core_vec_Vec__m0_std_fs_path_Path",
        "call m0_std_core_map_CStringUsizeMap_contains",
        "call m0_std_core_map_CStringUsizeMap_destroy",
        "call m0_std_core_map_CStringUsizeMap_get",
        "call m0_std_core_map_CStringUsizeMap_insert_absent",
        "call m0_std_core_map_CStringUsizeMap_len",
        "call m0_std_core_map_CStringUsizeMap_remove",
        "call m0_std_core_map_CStringUsizeMap_reserve",
        "call m0_std_core_map_cstring_usize_remove",
        "call m0_std_core_map_cstring_usize_new",
        ...
        "call m0_std_fs_path_Path_as_span",
        "call m0_std_fs_path_Path_destroy",
        "call m0_std_fs_path_Path_from_str",
        "call m0_m1_axbuild_main_cleanup_path",
        "call m0_m1_axbuild_main_Project_cycle_path",
        "call m0_m1_axbuild_main_Project_cycle_path_names",
        "call m0_m1_axbuild_main_custom_command_empty",
        ...
        "call m0_m1_axbuild_main_project_sources_match_directory_entries_impl",
        ...
        "call m0_m1_axbuild_main_target_disown_after_move",
