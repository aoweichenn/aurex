...
TEST_F(AurexIntegrationTest, SampleSuite_Std_std_dir) {
    ...
    expect_contains_all(checked, {
        ...
        "fn std.core.vec.clear_deep<std.fs.dir.DirectoryEntry> -> void",
        "fn std.core.vec.truncate_deep<std.fs.dir.DirectoryEntry> -> void",
        "fn method std.fs.path.Path.from_str -> std.core.result.Result<std.fs.path.Path, i32>",
    });
...
TEST_F(AurexIntegrationTest, StdCollectionsPathSampleExposesM1ContainerBaseline) {
    ...
    expect_contains_all(checked, {
        ...
        "fn check_vec_path_deep_destroy -> std.core.result.Result<bool, i32>",
        ...
        "fn method std.core.vec.Vec<std.fs.path.Path>.truncate_deep -> void",
        "fn method std.core.vec.Vec<std.fs.path.Path>.clear_deep -> void",
        "fn method std.core.vec.Vec<std.fs.path.Path>.destroy_deep -> void",
        "fn std.core.vec.truncate_deep<std.fs.path.Path> -> void",
        "fn std.core.vec.clear_deep<std.fs.path.Path> -> void",
