...
[[nodiscard]] inline FunctionParam function_param(
    Module& module,
...
[[nodiscard]] inline RecordField record_field(
    Module& module,
    const std::string_view name,
    const TypeHandle type
) {
...
[[nodiscard]] inline FieldValue field_value(
    Module& module,
    const std::string_view name,
    const ValueId value
) {
...
[[nodiscard]] inline GlobalConstant global_constant(
    Module& module,
    const std::string_view name,
...
[[nodiscard]] inline RecordLayout record_layout(
    Module& module,
    const TypeHandle type,
    const std::string_view name,
    const std::string_view symbol,
...
inline void append_record_with_fields(
    ...
    const std::string_view symbol,
    const bool is_opaque,
    std::initializer_list<RecordField> fields
) {
...
[[nodiscard]] inline Module make_simple_module() {
    Module module;
    append_function(module, make_return_function(
        module,
        "answer",
