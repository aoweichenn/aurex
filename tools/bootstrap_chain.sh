...
"${STAGE1_BIN}" "${ROOT}/selfhost/src/aurex/selfhost/lexer/core.ax" "${ROOT}/selfhost/src/aurex/selfhost/syntax/ast.ax" "${ROOT}/selfhost/src/aurex/selfhost/parser/cursor.ax" "${ROOT}/selfhost/src/aurex/selfhost/parser/types.ax" "${ROOT}/selfhost/src/aurex/selfhost/parser/expr.ax" "${ROOT}/selfhost/src/aurex/selfhost/parser/seed.ax" "${PARSER_SMOKE}" "${STAGE1_PARSER_SMOKE_C}"
grep -q '#define parse_seed_module m0_aurex_selfhost_parser_seed_parse_seed_module' "${STAGE1_PARSER_SMOKE_C}"
grep -q '#define AstModule m0_aurex_selfhost_syntax_ast_AstModule' "${STAGE1_PARSER_SMOKE_C}"
