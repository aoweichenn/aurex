...
"${STAGE1_BIN}" "${ROOT}/selfhost/src/aurex/selfhost/lexer/core.ax" "${ROOT}/selfhost/src/aurex/selfhost/syntax/ast.ax" "${ROOT}/selfhost/src/aurex/selfhost/parser/seed.ax" "${PARSER_SMOKE}" "${STAGE1_PARSER_SMOKE_C}"
