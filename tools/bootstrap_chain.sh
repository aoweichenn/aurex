...
STAGE1_HELLO_IR="${SELFHOST_BUILD_DIR}/hello.stage1.air"
STAGE1_SEED_IR="${SELFHOST_BUILD_DIR}/aurexc_seed.stage1.air"
...
grep -q '; selfhost_module aurex.selfhost.bin.aurexc_stage1 lowering(ast_pending)' "${STAGE1_COMPILER_IR}"
