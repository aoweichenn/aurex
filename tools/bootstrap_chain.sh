...
grep -q 'static int32_t validate_ranges' "${STAGE1_LEXER_RANGES_C}"
...
grep -q 'static bool parse_seed_module' "${STAGE1_PARSER_SMOKE_C}"
...
grep -q 'static FileBuffer read_file' "${STAGE1_LEXER_FILE_C}"
