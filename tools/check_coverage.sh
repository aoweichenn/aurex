...
LINE_THRESHOLD="${AUREX_COVERAGE_LINE_THRESHOLD:-90}"
FUNCTION_THRESHOLD="${AUREX_COVERAGE_FUNCTION_THRESHOLD:-90}"
REGION_THRESHOLD="${AUREX_COVERAGE_REGION_THRESHOLD:-90}"
