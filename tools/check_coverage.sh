...
DEFAULT_FOCUSED_SOURCES="src/parse/parser_postfix.cpp:src/sema/match.cpp:src/sema/sema_expr.cpp:src/sema/sema_types.cpp:src/sema/internal/sema_builtin_expression_analyzer.cpp:src/sema/internal/sema_expression_analyzer.cpp:src/sema/internal/sema_lookup_resolver.cpp:src/sema/internal/sema_type_services.cpp"
